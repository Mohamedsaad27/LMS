...
@section('content')
    @include('layouts.dashboard.partials.breadcrumb', [
        'component' => trans('messages.create_organization'),
    ])
                    ...
                    <div class="card-body">
                        <form action="{{ route('organizations.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-2">
                                        <label for="established_year"
                                            class="form-label">{{ trans('messages.established_year') }}</label>
                                        <input type="number"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit"
                                        class="btn btn-primary">{{ trans('messages.create_organization') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
