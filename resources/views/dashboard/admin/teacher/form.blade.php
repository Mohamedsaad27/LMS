        ...
        <div class="col-lg-6">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                    id="name_en" name="name_en" value="{{ old('name_en', $teacher->name_en ?? '') }}" required>
                @error('name_en')
            ...
            <div class="mb-2">
                ...
                <input type="password" class="form-control @error('password') is-invalid @enderror"
                    id="password" name="password" {{ !isset($teacher) ? 'required' : '' }}>
                @error('password')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-2">
                <label for="date_of_birth"
                    class="form-label">{{ trans('messages.date_of_birth') }}</label>
                <input type="date"
            ...
            <div class="mb-2">
                <label for="experience_years"
                    class="form-label">{{ trans('messages.experience_years') }}</label>
                <input type="number"
        ...
        <div class="col-lg-6">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('name_ar') is-invalid @enderror"
                    id="name_ar" name="name_ar" value="{{ old('name_ar', $teacher->name_ar ?? '') }}" required>
                @error('name_ar')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('address') is-invalid @enderror"
                    id="address" name="address" value="{{ old('address', $teacher->address ?? '') }}" required>
                @error('address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-2">
                <label for="qualification"
                    class="form-label">{{ trans('messages.qualification') }}</label>
                <input type="text"
            ...
            <div class="mb-2">
                ...
                <input id="subjects-input"
                    ...
                    placeholder="{{ trans('messages.subjects') }}" required>
                @error('subjects')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                ...
                <script>
                    ...
                    @if (old('subjects') || isset($teacher))
                        ...
                        @foreach ($subjects as $subject)
                            @if ((old('subjects') && in_array($subject->id, old('subjects'))) || 
            ...
            <div class="mb-2">
                ...
                @if(isset($teacher) && $teacher->photo)
                    <div class="mt-2">
                        <img src="{{ asset($teacher->photo) }}" alt="Teacher photo" class="img-thumbnail" width="100">
                    </div>
                @endif
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="number" step="0.01"
                    ...
                    name="salary" value="{{ old('salary', $teacher->salary ?? '') }}" required>
                @error('salary')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                ...
                <script>
                    ...
                    @if (old('grades') || isset($teacher))
                        ...
                        @foreach ($grades as $grade)
                            @if ((old('grades') && in_array($grade->id, old('grades'))) || 
