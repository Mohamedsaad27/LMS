...
@section('content')
    @include('layouts.dashboard.partials.breadcrumb', ['component' => 'Grades'])
    @if (session('success'))
        <script>
            iziToast.success({
                title: 'Success',
                                    ...
                                    <td class="px-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <button type="button" class="btn btn-sm btn-light-primary"
                                                ...
                                                data-bs-target="#descriptionModal{{ $grade->id }}">
                                                {{ __('dashboard.view_description') }}
                                            </button>
                                        </div>

                                        {{-- modal for description --}}
                                        <div class="modal fade" id="descriptionModal{{ $grade->id }}" tabindex="-1"
