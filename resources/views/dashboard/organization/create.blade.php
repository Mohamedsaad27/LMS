...
@section('content')
    @include('layouts.dashboard.breadcrumb', ['component' => 'Create Organization'])

    <div class="container-fluid px-4">
        <!-- Header Section -->
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 text-gray-800 mb-0">Create Organization</h2>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control @error('established_year') is-invalid @enderror" 
                                               ...
                                               value="{{ old('established_year') }}" min="1900" max="{{ date('Y') }}" placeholder="Enter established year">
