                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">{{ __('dashboard.schools') }}</h2>
                                <h3 class="fw-extrabold mb-1">{{ $schools->count() }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">{{ __('dashboard.schools') }} </h2>
                                <h3 class="fw-extrabold mb-2">{{ $schools->count() }}</h3>
                            </div>
                            <small class="d-flex align-items-center text-gray-500">
                                @if($schools->isNotEmpty())
                                    {{ \Carbon\Carbon::parse($schools->first()->created_at)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($schools->last()->created_at)->format('M d, Y') }},
                                @endif
                            ...
                            <div class="small d-flex mt-1">
                                <div>Since last month <svg class="icon icon-xs text-success" fill="currentColor"
                                        ...
                                        <path fill-rule="evenodd"
                                            ...
                                            clip-rule="evenodd"></path>
                                    </svg><span class="text-success fw-bolder">{{ $schools->count() - 1 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">{{ __('dashboard.organizations') }}</h2>
                                <h3 class="mb-1">{{ $organizations->count() }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">{{ __('dashboard.organizations') }}</h2>
                                <h3 class="fw-extrabold mb-2">{{ $organizations->count() }}</h3>
                            </div>
                            <small class="d-flex align-items-center text-gray-500">
                                @if($organizations->isNotEmpty())
                                    {{ \Carbon\Carbon::parse($organizations->first()->created_at)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($organizations->last()->created_at)->format('M d, Y') }},
                                @endif
                            ...
                            <div class="small d-flex mt-1">
                                <div>Since last month <svg class="icon icon-xs text-danger" fill="currentColor"
                                        ...
                                        <path fill-rule="evenodd"
                                            ...
                                            clip-rule="evenodd"></path>
                                    </svg><span class="text-danger fw-bolder">{{ $organizations->count() - 1 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            ...
                            <small class="text-gray-500">
                                @if($students->isNotEmpty())
                                    {{ \Carbon\Carbon::parse($students->first()->created_at)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($students->last()->created_at)->format('M d, Y') }},
                                @endif
                            </small>
                            <div class="small d-flex mt-1">
                                <div>Since last month <svg class="icon icon-xs text-success" fill="currentColor"
                                        ...
                                        <path fill-rule="evenodd"
                                            d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z"
                                            clip-rule="evenodd"></path>
                                    </svg><span class="text-success fw-bolder">{{ $students->count() - 1 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
