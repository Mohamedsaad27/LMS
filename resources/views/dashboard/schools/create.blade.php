                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en"
                                            rows="4" placeholder="Enter English description">{{ old('description_en') }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar"
                                            name="description_ar" rows="4" placeholder="Enter Arabic description">{{ old('description_ar') }}</textarea>
